...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13697 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13697 = (function (val,box,meta13698){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13697.cljs$lang$type = true;
cljs.core.async.impl.channels.t13697.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13697";
cljs.core.async.impl.channels.t13697.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13697");
});
cljs.core.async.impl.channels.t13697.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13697.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13699){var self__ = this;
var _13699__$1 = this;return self__.meta13698;
});
cljs.core.async.impl.channels.t13697.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13699,meta13698__$1){var self__ = this;
var _13699__$1 = this;return (new cljs.core.async.impl.channels.t13697(self__.val,self__.box,meta13698__$1));
});
cljs.core.async.impl.channels.__GT_t13697 = (function __GT_t13697(val__$1,box__$1,meta13698){return (new cljs.core.async.impl.channels.t13697(val__$1,box__$1,meta13698));
});
}
return (new cljs.core.async.impl.channels.t13697(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13700 = self__.takes.pop();if((taker_13700 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13700))
{var take_cb_13701 = cljs.core.async.impl.protocols.commit.call(null,taker_13700);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13701,taker_13700){
return (function (){return take_cb_13701.call(null,null);
});})(take_cb_13701,taker_13700))
);
} else
{}
{
