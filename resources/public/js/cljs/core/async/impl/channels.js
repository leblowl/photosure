...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13944 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13944 = (function (val,box,meta13945){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13944.cljs$lang$type = true;
cljs.core.async.impl.channels.t13944.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13944";
cljs.core.async.impl.channels.t13944.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/t13944");
});
cljs.core.async.impl.channels.t13944.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13944.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13946){var self__ = this;
var _13946__$1 = this;return self__.meta13945;
});
cljs.core.async.impl.channels.t13944.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13946,meta13945__$1){var self__ = this;
var _13946__$1 = this;return (new cljs.core.async.impl.channels.t13944(self__.val,self__.box,meta13945__$1));
});
cljs.core.async.impl.channels.__GT_t13944 = (function __GT_t13944(val__$1,box__$1,meta13945){return (new cljs.core.async.impl.channels.t13944(val__$1,box__$1,meta13945));
});
}
return (new cljs.core.async.impl.channels.t13944(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13947 = self__.takes.pop();if((taker_13947 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13947))
{var take_cb_13948 = cljs.core.async.impl.protocols.commit.call(null,taker_13947);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13948,taker_13947,this$__$1){
return (function (){return take_cb_13948.call(null,null);
});})(take_cb_13948,taker_13947,this$__$1))
);
} else
{}
{
