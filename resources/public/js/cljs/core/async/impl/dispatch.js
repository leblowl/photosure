...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14068 = 0;while(true){
var m_14069 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14069 == null))
{} else
{m_14069.call(null);
if((count_14068 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14070 = (count_14068 + 1);
count_14068 = G__14070;
continue;
}
} else
{}
