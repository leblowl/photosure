...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14288 = (0);while(true){
var m_14289 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14289 == null))
{} else
{m_14289.call(null);
if((count_14288 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14290 = (count_14288 + (1));
count_14288 = G__14290;
continue;
}
} else
{}
