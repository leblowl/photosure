...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13938 = (0);while(true){
var m_13939 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13939 == null))
{} else
{m_13939.call(null);
if((count_13938 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13940 = (count_13938 + (1));
count_13938 = G__13940;
continue;
}
} else
{}
