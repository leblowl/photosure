...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13691 = 0;while(true){
var m_13692 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13692 == null))
{} else
{m_13692.call(null);
if((count_13691 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13693 = (count_13691 + 1);
count_13691 = G__13693;
continue;
}
} else
{}
