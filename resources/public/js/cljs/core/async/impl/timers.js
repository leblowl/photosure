...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14103 = 0;while(true){
if((i_14103 < arr.length))
{(arr[i_14103] = null);
{
...
{var i_14110 = (self__.level + 1);while(true){
if((i_14110 <= (new_level + 1)))
{(update[i_14110] = self__.header);
{
var G__14111 = (i_14110 + 1);
i_14110 = G__14111;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14112 = 0;while(true){
if((i_14112 <= self__.level))
{var links_14113 = (update[i_14112]).forward;if(((links_14113[i_14112]) === x__$1))
{(links_14113[i_14112] = (x__$1.forward[i_14112]));
{
