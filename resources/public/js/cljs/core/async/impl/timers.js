...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14195 = (0);while(true){
if((i_14195 < arr.length))
{(arr[i_14195] = null);
{
...
{var i_14202 = (self__.level + (1));while(true){
if((i_14202 <= (new_level + (1))))
{(update[i_14202] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14204 = (0);while(true){
if((i_14204 <= self__.level))
{var links_14205 = (update[i_14204]).forward;if(((links_14205[i_14204]) === x__$1))
{(links_14205[i_14204] = (x__$1.forward[i_14204]));
{
var G__14206 = (i_14204 + (1));
i_14204 = G__14206;
continue;
}
} else
{{
var G__14207 = (i_14204 + (1));
i_14204 = G__14207;
continue;
}
}
