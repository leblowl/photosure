...
{{
var G__18215 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18215;
continue;
}
} else
...
{var pred__18219 = cljs.core._EQ_;var expr__18220 = limit;if(cljs.core.truth_(pred__18219.call(null,1,expr__18220)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18219.call(null,2,expr__18220)))
...
var G__18222 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18223 = (limit__$1 - 1);
var G__18224 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18222;
limit__$1 = G__18223;
parts = G__18224;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___18226 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___18226))
{var replacement_18227 = temp__4090__auto___18226;buffer.append([cljs.core.str(replacement_18227)].join(''));
} else
{buffer.append(ch);
}
{
var G__18228 = (index + 1);
index = G__18228;
continue;
}
}
