...
{{
var G__11414 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11414;
continue;
}
} else
...
{var pred__11418 = cljs.core._EQ_;var expr__11419 = limit;if(cljs.core.truth_(pred__11418.call(null,1,expr__11419)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11418.call(null,2,expr__11419)))
...
var G__11421 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11422 = (limit__$1 - 1);
var G__11423 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11421;
limit__$1 = G__11422;
parts = G__11423;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11425 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11425))
{var replacement_11426 = temp__4090__auto___11425;buffer.append([cljs.core.str(replacement_11426)].join(''));
} else
{buffer.append(ch);
}
{
var G__11427 = (index + 1);
index = G__11427;
continue;
}
}
