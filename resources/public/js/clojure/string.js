...
{{
var G__13861 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13861;
continue;
}
} else
...
{var pred__13865 = cljs.core._EQ_;var expr__13866 = limit;if(cljs.core.truth_(pred__13865.call(null,1,expr__13866)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13865.call(null,2,expr__13866)))
...
var G__13868 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13869 = (limit__$1 - 1);
var G__13870 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13868;
limit__$1 = G__13869;
parts = G__13870;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13872 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13872))
{var replacement_13873 = temp__4090__auto___13872;buffer.append([cljs.core.str(replacement_13873)].join(''));
} else
{buffer.append(ch);
}
{
var G__13874 = (index + 1);
index = G__13874;
continue;
}
}
